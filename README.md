...
カラム型UI、追加・削除・対象設定、編集可能なメインメニュー、複数アカウント切替、日本語と主要10言語の辞書・RTL、表示言語へ合わせた投稿の自動翻訳と原文切替、リポスト元の通常カード表示とWeb準拠の引用カード、Web版Xに沿う表示設定、暗号化Vault、Web Cookie認証付きGraphQL/REST、ホーム・通知・ユーザー・リスト・履歴・検索・トレンド・DM受信箱、無限スクロール、投稿形式フィルター、アプリ内ユーザープロフィール、投稿・返信・引用・いいね・リポスト・履歴保存まで製品経路へ接続しています。
