...
- デスクトップ版の動画で再生・一時停止、シーク、ミュート、音量、ループ、全画面、Picture-in-Pictureを順に操作し、押下やドラッグが動画のピンチ操作へ奪われず状態が維持されることを確認します。初期ミュートからシークまたは音量を直接操作した場合は、自動的にミュート解除されることも確認します。
